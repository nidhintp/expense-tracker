...
urlpatterns = [
    ...
    path("transactions/all/",views.TransactionList.as_view(),name="transaction-list"),
    ...
    path("transactions/<int:pk>/update/",views.TransactionUpdate.as_view(),name="transaction-edit"),
